      ...
      <div className='py-4'>
        <div className='container flex justify-between'>
          ...
          <div className='flex items-center gap-4'>
            <a href='#'
            className='text-primary font-semibold tracking-widest test-2xl uppercase sm:text-3xl'>
              Eshop</a>
              {/* Menu Items */}
              <div className='hidden lg:block'>
                <ul className='flex items-center gap-4'>
                  ...
                  <li className='relative cursor-pointer group'>
                    ...
                    {/* Dropdown Links */}
                    <div className='absolute z-[9999] hidden group group-hover:block w-[200px] rounded-md bg-white shadow-md dark:bg-gray-900 p-2 dark:text-white'>
